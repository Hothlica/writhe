...
public class ModShortPlantBlock extends ShortPlantBlock {
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return floor.isIn(BlockTags.NYLIUM) || floor.isOf(ModBlocks.SOULSTONE) || floor.isOf(Blocks.SOUL_SOIL) || super.canPlantOnTop(floor, world, pos);
    }

    @Override
    public void grow(ServerWorld world, Random random, BlockPos pos, BlockState state) {
        ModTallPlantBlock tallPlantBlock = (ModTallPlantBlock) ModBlocks.TALL_WREATHEN_GRASS;
